...
Route.create(start_airport: Airport.find(3), end_airport: Airport.find(1), duration: 497)
Route.create(start_airport: Airport.find(1), end_airport: Airport.find(5), duration: 640)
Route.create(start_airport: Airport.find(5), end_airport: Airport.find(1), duration: 640)
Route.create(start_airport: Airport.find(4), end_airport: Airport.find(8), duration: 643)
